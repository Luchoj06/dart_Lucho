...
void main() {
  ...
  int restoHarina = M % 24;

  int cajasAceite = N ~/ 15;
  int restoAceite = N % 15;

  double ingresoHarina = bultosHarina * B1 + restoHarina * B3;
  double ingresoAceite = cajasAceite * B2 + restoAceite * B4;

  double total = ingresoHarina + ingresoAceite;

  print("23. Ingreso total por tonelada: $total");
}
